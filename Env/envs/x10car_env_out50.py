...
from Env.envs.envs.agents import Drone2
...
from Env.resources.ball2_1 import ball2_1
from Env.resources.ball2_2 import ball2_2
from Env.resources.ball2_3 import ball2_3
from Env.resources.ball2_4 import ball2_4
from Env.resources.ball2_5 import ball2_5
from Env.resources.ball2_6 import ball2_6
from Env.resources.ball2_7 import ball2_7
from Env.resources.ball2_8 import ball2_8
from Env.resources.ball2_9 import ball2_9
from Env.resources.ball2_10 import ball2_10
from Env.resources.ball2_11 import ball2_11
from Env.resources.ball2_12 import ball2_12
from Env.resources.ball2_13 import ball2_13
from Env.resources.ball2_14 import ball2_14
from Env.resources.ball2_15 import ball2_15
from Env.resources.ball2_16 import ball2_16
...
class X10Car_Env_out50(gym.Env):
    ...
    def __init__(self):
        ...
        # self.client_2 = p.connect(p.DIRECT)
    ...
    def step(self, action):
        ...
        self.car1.apply_action(action)# perform action
        # self.car2.apply_action([1, 0.2])  # perform action
        self.car2.apply_action(action)  # perform action
        self.car3.apply_action(action)
        # self.car4.apply_action([0.1, 0])
        self.air.apply_action([0.1, 0.1, 0.1, 0.1])
        self.air2.apply_action([0.1, 0.1, 0.1, 0.1])
        p.stepSimulation()
        car_ob = self.car1.get_observation() # return state
        # car_ob = self.car2.get_observation()  # return state
        dist_to_wall = self.car1.get_distance()
        # dist_to_wall = self.car2.get_distance()
    ...
    def reset(self):
        ...
        self.car1 = x10car_v0(self.client)
        self.car2 = x_mycar(self.client)
        self.car3 = x_mycar2(self.client)
        # self.car4 = RaceCar(self.client)
        self.air = Drone(self.client)
        self.air2 = Drone2(self.client)

        self.ball1 = ball1(self.client)
        self.ball2 = ball2(self.client)
        self.ball3 = ball3(self.client)
        self.ball4 = ball4(self.client)
        self.ball2_1 = ball2_1(self.client)
        self.ball2_2 = ball2_2(self.client)
        self.ball2_3 = ball2_3(self.client)
        self.ball2_4 = ball2_4(self.client)
        self.ball2_5 = ball2_5(self.client)
        self.ball2_6 = ball2_6(self.client)
        self.ball2_7 = ball2_7(self.client)
        self.ball2_8 = ball2_8(self.client)
        self.ball2_9 = ball2_9(self.client)
        self.ball2_10 = ball2_10(self.client)
        self.ball2_11= ball2_11(self.client)
        self.ball2_12 = ball2_12(self.client)
        self.ball2_13 = ball2_13(self.client)
        self.ball2_14 = ball2_14(self.client)
        self.ball2_15 = ball2_15(self.client)
        self.ball2_16 = ball2_16(self.client)
        ...
        self.tree_15=tree_15_1(self.client); self.tree_16=tree_16_1(self.client);
        self.tree_17=tree_17_1(self.client); self.tree_34=tree_34_1(self.client); self.tree_35=tree_35_1(self.client); self.tree_36=tree_36_1(self.client)
        ...
        self.prev_dist_to_wall = self.car1.get_distance()
        # self.prev_dist_to_wall = self.car2.get_distance()
        return np.array(self.prev_dist_to_wall, dtype=np.float32)

    def render(self, mode='human'):
        if self.rendered_img is None:
            self.rendered_img = plt.imshow(np.zeros((400, 400, 4)))

        # Base information
        car_id, client_id = self.car1.get_ids()
        # car_id, client_id = self.car2.get_ids()
